# TodoPriority - 우선 순위 기반 시간 관리 어플리케이션

## 개요

해야 할 일도 하고자 하는 일도 많은데 시간은 부족하고 어떤 일부터 시작해야 할지 
막막해하고 고민하며 때로는 차일피일 미루기만 하다 기한을 놓치는 경우가 더러 있다.
시간 관리 문제의 원인은 시간 관리 방법을 제대로 파악하지 못했기 때문이다.
계획을 짜는 것은 귀찮고 시간이 오래 걸리는 일이며 어떤 일을 먼저 배치해야할지 막막하다.
이러한 시간 관리에 대한 고민을 해결하기 위해 우선 순위 기반 시간 관리 어플리케이션 TodoPriority를 제작하게 되었다.  

* 소프트웨어 설계 및 실험(CP33987) 과목 텀프로젝트로 제작되었다.  
* 수행 기간: 2020-04-06 ~ 2020-07-11  

### 1. 시연 영상


https://user-images.githubusercontent.com/34941061/152909646-4a7e778e-a886-45da-a0a8-78d19fe03eab.mp4
...
https://user-images.githubusercontent.com/34941061/152909661-c690ef5c-aac8-4302-904c-5a81903a9fdd.mp4
...
<img src="./media/시간관리필요성차트.png" alt="시간 관리 필요성 차트" width="49%"/> <img src="./media/시간관리방법차트.png" alt="시간 관리 방법 차트" width="49%"/>
...
https://play.google.com/store 에서 검색됨
